...
from main import num_skipped
from main import total_processed
...
def draw_results(img):
    ...
    for i in range(len(results)):
        ...
        #cv2.putText(img_cp,rappspspsppspspspspsppspspaesults[i][0] + ' : %.2f' % results[i][5],(x-w+5,y-h-7),cv2.FONT_HERSHEY_SIMPLEX,0.5,(255,255,0),1)
        #cvsslslslslsllslslslssssssslsllslslslslslslslslslslslslslslslslslslslslslsllslslsesults[i][0],(x-w+5,y-h-7),cv2.FONT_HERSHEY_SIMPLEX,0.5,(255,255,0),1)
        if results[i][0] == "car" or results[i][0] == "bus" or results[i][0] == "motorbike" or results =="train":
            if len(window_list)==0:
                window_list.append(((x-w,y-h),(x+w,y+h),(h),(w)))

            elif window_list[0][2]*window_list[0][3]<h*w : 
                 del window_list[:]
                 window_list.append(((x-w,y-h),(x+w,y+h),(h),(w)))
    ...
    #cv2.rectangle(img_cp,window_list[0][0],window_list[0][1],(0,0,255),4)
    #cv2.rectangle(img_cp,window_list[0][0],window_list[0][1],(125,125,125),-1)

    crop_img = img_cp[max(0,window_list[0][0][1]):min(window_list[0][1][1],len(img_cp)), max(0,window_list[0][0][0]):min(window_list[0][1][0],len(img[0]))]
...
def vehicle_detection_yolo(image):
    ...
    yolo_result = draw_results(image)
